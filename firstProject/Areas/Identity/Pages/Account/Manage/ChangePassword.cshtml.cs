...
namespace firstProject.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("NewPassword", ErrorMessage = "پسورد جدید و تکرار آن یکسان نیست")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("کاربر پسورد خود را با موفقیت عوض کرد");
            StatusMessage = "رمز شما تغییر کرد";
